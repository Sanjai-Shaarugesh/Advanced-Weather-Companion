...
// gettext is injected at runtime by callers; fall back to identity
// so this module can be imported without a live extension context.
let _gettext = s => s;
export function setGettext(fn) { _gettext = fn; }
  ...
  weatherapi: {
    ...
    parseResponse(response) {
      ...
      return {
        current: {
          ...
          weather_code: this._convertCode(response.current.condition?.code ?? 1000),
    ...
    _convertCode(code) {
      const map = {
        ...
        1063:61, 1180:61, 1183:61, 1186:63, 1189:63, 1192:65, 1195:65,
        1150:51, 1153:51, 1168:55, 1171:55,
        1066:71, 1210:71, 1213:73, 1216:73, 1219:75, 1222:75, 1225:75,
        1069:77, 1204:77, 1207:77, 1114:77, 1117:77,
        1072:55,
        1087:95, 1273:95, 1276:95, 1279:95, 1282:95,
        1237:77, 1261:85, 1264:86,
        1246:82, 1243:81, 1240:80,
      };
      return map[code] ?? 0;
    },
  },
...
// getWeatherConditions() is called at display time so that the active
// gettext function is used, producing translated condition names.
export function getWeatherConditions() {
  return {
    0:  {name:_("Clear Sky"),           icon:"weather-clear-symbolic",             severity:"normal"},
    1:  {name:_("Mainly Clear"),        icon:"weather-few-clouds-symbolic",        severity:"normal"},
    2:  {name:_("Partly Cloudy"),       icon:"weather-few-clouds-symbolic",        severity:"normal"},
    3:  {name:_("Overcast"),            icon:"weather-overcast-symbolic",          severity:"normal"},
    45: {name:_("Fog"),                 icon:"weather-fog-symbolic",               severity:"caution"},
    48: {name:_("Rime Fog"),            icon:"weather-fog-symbolic",               severity:"caution"},
    51: {name:_("Light Drizzle"),       icon:"weather-showers-scattered-symbolic", severity:"normal"},
    53: {name:_("Drizzle"),             icon:"weather-showers-symbolic",           severity:"normal"},
    55: {name:_("Heavy Drizzle"),       icon:"weather-showers-symbolic",           severity:"caution"},
    61: {name:_("Light Rain"),          icon:"weather-showers-scattered-symbolic", severity:"normal"},
    63: {name:_("Rain"),                icon:"weather-showers-symbolic",           severity:"normal"},
    65: {name:_("Heavy Rain"),          icon:"weather-storm-symbolic",             severity:"warning"},
    71: {name:_("Light Snow"),          icon:"weather-snow-symbolic",              severity:"normal"},
    73: {name:_("Snow"),                icon:"weather-snow-symbolic",              severity:"caution"},
    75: {name:_("Heavy Snow"),          icon:"weather-snow-symbolic",              severity:"warning"},
    77: {name:_("Snow Grains"),         icon:"weather-snow-symbolic",              severity:"caution"},
    80: {name:_("Rain Showers"),        icon:"weather-showers-scattered-symbolic", severity:"normal"},
    81: {name:_("Rain Showers"),        icon:"weather-showers-symbolic",           severity:"caution"},
    82: {name:_("Heavy Showers"),       icon:"weather-storm-symbolic",             severity:"warning"},
    85: {name:_("Snow Showers"),        icon:"weather-snow-symbolic",              severity:"caution"},
    86: {name:_("Heavy Snow Showers"),  icon:"weather-snow-symbolic",              severity:"warning"},
    95: {name:_("Thunderstorm"),        icon:"weather-storm-symbolic",             severity:"severe"},
    96: {name:_("Hail Storm"),          icon:"weather-storm-symbolic",             severity:"severe"},
    99: {name:_("Heavy Hail"),          icon:"weather-storm-symbolic",             severity:"severe"},
  };
}

// Static fallback (untranslated) – kept for backwards compatibility.
export const WEATHER_CONDITIONS = {
  ...
  86: {name:"Heavy Snow Showers",  icon:"weather-snow-symbolic",              severity:"warning"},
